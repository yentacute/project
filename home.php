...
product.id_cate = categories.id_cate order by id desc limit 6
";
$stmt=$conn->prepare("$sql");
$stmt->execute();
							...
							<div class="products-slick" data-nav="#slick-nav-2">
								...
								foreach ($detailproduct as $product) {
									...
									<div class="product-body">
										...
										<div class="product-btns">
											<a href="product.php?id=<?=$product['id']?>?cate_id=<?=$product['cate_id']?>"><button class="quick-view"><i class="fa fa-eye"></i><span class="tooltipp"> QUICK VIEW</span></button></a>
										</div>
									</div>
									<div class="add-to-cart">
										<button class="add-to-cart-btn"><i class="fa fa-shopping-cart"></i> add to cart</button>
		...
		<div class="row">
			<div class="section-title">
				...
				<div class="section-nav">
					<?php foreach ($cate as $value) { ?>
						<ul class="section-tab-nav tab-nav">
							<li class="active"><a href="store.php?id_cate=<?php echo $value['id_cate'] ?>"><?php echo $value['name_cate'] ?></a></li>
						</ul>
					<?php } ?>
				</div>
				<div class="col-md-12">
